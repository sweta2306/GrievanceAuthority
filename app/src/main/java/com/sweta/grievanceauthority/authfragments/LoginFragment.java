...
import com.sweta.grievanceauthority.Pages.ShowUsersActivity;
import com.sweta.grievanceauthority.Pages.UsersActivity;
                ...
                if (Email.equals("authority@gmail.com") && Password.equals("12345678")) {
                    ...
                    mAuth.signInWithEmailAndPassword(Email, Password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            mProg.dismiss();
                            Intent main_Activity = new Intent(getActivity(), UsersActivity.class);
                            //getActivity().finish();
