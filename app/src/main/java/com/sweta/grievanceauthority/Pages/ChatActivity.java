...
import com.sweta.grievanceauthority.Services.MyService;
import com.sweta.grievanceauthority.adapter.ChatAdapter;
import com.sweta.grievanceauthority.model.ChatModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageChatDatabase=FirebaseDatabase.getInstance().getReference().child("Chats").child(mAuth.getCurrentUser().getUid()).child(mRecipientId);
